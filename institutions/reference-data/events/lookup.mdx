...
description: "Resolve a Kalshi or Polymarket ticker to its Oddpool event, outcomes, and venue sides."
api: "GET https://api.oddpool.com/reference/events/lookup"
---

Give this endpoint a Kalshi or Polymarket id and it returns the matched event: its Oddpool ID, every venue that lists it, every outcome, the entity each outcome refers to, and the venue ticker you trade on each side.
