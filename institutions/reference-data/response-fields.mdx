...
<ResponseField name="venue_yes_token" type="string | null">Polymarket CLOB token id for the YES side. `null` on Kalshi and Polymarket US (neither uses CLOB tokens).</ResponseField>
