...
<ParamField body="notify_on_whale_trade" type="boolean" default="true">
...
| Status | Reason |
| ------ | ------ |
| `400` | Invalid `exchange`, malformed `event_ticker`, the event is already resolved, or you already track it. |
